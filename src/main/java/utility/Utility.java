...
public class Utility 
{
	...
	File dest=new File("C:\\Users\\hp1\\git\\PolicyBazaarSite\\PolicyBazaar\\ScreenShot\\"+fileName+".png");
	...
	public static String readDataFromPropertiyFile(String key) throws IOException
	{
		...
		FileInputStream myfile= new FileInputStream("C:\\Users\\hp1\\git\\PolicyBazaarSite\\PolicyBazaar\\PB_TCPropertyFile.properties");
		prop.load(myfile);
